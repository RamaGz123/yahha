 ...
 *Powered By @${'6281365255567'.split('@')[0]}*`
 ...
   "productImage":{ 
   "mimetype": "image/jpeg", 
   "jpegThumbnail": await (await fetch('https://telegra.ph/file/87e5b3c1a8cc38d347917.jpg')).buffer(), //Gambarnye
     }, 
   "title": `${ucapan()}`, 
 ...
 const fload = {
    ...
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/87e5b3c1a8cc38d347917.jpg')).buffer(), //Gambarnye
...
Saya Adalah RamaBotz Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
         externalAdReply: { 
             title: 'HAORI IQ-MD Testing Project By Syah', 
