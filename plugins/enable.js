...
Sticker`
    ...
    await conn.send2ButtonLoc(m.chat, await conn.resize('https://telegra.ph/file/9797ca775a01b42929b1b.jpg', 300, 180), `🗂️ *Type:* ${type} 
📊 *Status:* Succes ✅
🎚️ *Options:* ${isEnable ? 'Enable' : 'Disable'}
📣 *For:* ${isAll ? 'This Bot' : isUser ? '' : 'This Chats'}`, wm, `⋮☰ Menu`, '.menu', `${isEnable ? 'Off' : 'On'} ${type}`, `.${isEnable ? 'Off' : 'On'} ${type}`, m)
}
