let fs = require('fs') 
 ...
          let uptime = clockString(_uptime)  
   const ultah = new Date('Jully 27, 2023 23:59:59')
 ...
        await this.setBio(`☘️ Ultah RamaKull : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 Made Rama`).catch(_ => _)  
